  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        always looking to learn new technologies. I am currently working for the <span className="underline">Office of the New York State Attorney General</span> as a{" "}
